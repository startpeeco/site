...
closeButton.addEventListener("click", function() {
    mobileMenu.style.transform = "translateX(100%)"
          ...
          <div className="home-div">
            <DangerousHTML
              html={`<iframe width="400" height="250" src="https://www.youtube.com/embed/mSadzhf98oU" title="Assessoria de tecnologia e negócios Grátis #business #startup" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`}
            ></DangerousHTML>
          </div>
        </section>
