    ...
    <>
      <div className="home-container">
        <Head>
          ...
          <meta
            property="og:image"
            content="https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/069dabfd-7970-4bcc-8d3b-7cc4e28a5879/1928967d-88fc-4df0-825e-b579c6fe81ba?org_if_sml=1"
          />
        </Head>
          ...
          <div className="home-menu">
            <div id="mobile-menu" className="home-mobile-navigation">
              ...
              <div className="home-links">
                ...
                <a
                  href="https://clientestart.flutterflow.app/"
                  target="_blank"
                ...
                <div className="home-right">
                  ...
                  >
                    <div className="home-get-started">
                      <span className="home-text01">Continuar</span>
                    </div>
                  </a>
...
closeButton.addEventListener("click", function() {
    mobileMenu.style.transform = "translateX(100%)"
          ...
          <div className="home-div">
            <Script
              html={`<script src="https://fast.wistia.com/embed/medias/4wcaviaz0l.jsonp" async></script><script src="https://fast.wistia.com/assets/external/E-v1.js" async></script><div class="wistia_responsive_padding" style="padding:66.67% 0 0 0;position:relative;"><div class="wistia_responsive_wrapper" style="height:100%;left:0;position:absolute;top:0;width:100%;"><span class="wistia_embed wistia_async_4wcaviaz0l popover=true popoverAnimateThumbnail=true videoFoam=true" style="display:inline-block;height:100%;position:relative;width:100%">&nbsp;</span></div></div>`}
            ></Script>
          </div>
        </section>
        ...
        <footer className="home-footer">
          <div className="home-top">
            <div className="home-right1">
              <div className="home-category">
                ...
                >
                  <div className="home-links2">
                    <span className="home-text16">Assessoria de negócios</span>
              ...
              <div className="home-category1">
                <span className="home-text18">Empresa</span>
                <div className="home-links3">
                  <span className="home-text19">Quem somos</span>
                  <a
                    href="https://api.whatsapp.com/send?phone=5511967272695"
                  ...
                  >
                    <div className="home-container1">
                      <span className="home-text20">Trabalhe conosco</span>
                      <img
                        alt="image"
          ...
          <div className="home-bottom">
            ...
            <span className="home-text21">
              CNPJ 51.432.983/0001-76  São Paulo- SP 
            </span>
            <span className="home-text22">Copyright © Startpee - 2023</span>
          </div>
          <a
            href="https://www.reclameaqui.com.br/empresa/startpee/"
